...
@rem ##########################################################################
@rem
@rem  TS_HLA_EncodingRulesTester startup script for Windows
@rem
@rem ##########################################################################
...
:fail
rem Set variable TS_HLA_ENCODING_RULES_TESTER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%TS_HLA_ENCODING_RULES_TESTER_EXIT_CONSOLE%" exit 1
exit /b 1
