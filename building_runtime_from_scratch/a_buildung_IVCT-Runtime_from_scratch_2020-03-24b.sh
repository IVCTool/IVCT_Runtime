...
# we need a java - runtime or  JDK somewhere on our system
export JAVA_HOME=/opt/jdk1.8.0_161

# in this Dir  we install all             ### change this to your path 
export IVCTTOOL_Dir=/opt/IVCTool_b
...
sudo chown -R brf ${RUNTIME_Dir}/apache-tomcat-8.5.51
...
# e.g. apache-activemq-5.15.11-bin.tar.gz   to temp_src/
                                                  ...
                                                  ##dectivate after the first run
tar -xzf /opt/temp_src/apache-activemq-5.15.11-bin.tar.gz
...
echo -e "\n##you may need a gradle.properties with:"
...
####  server.xml als Beispiel zufuegen
